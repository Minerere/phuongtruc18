...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div class="mx-2 row">
					...
					<form:form modelAttribute="user" action="/update-user" method="post" enctype="multipart/form-data">	
					<div class="form-group">
					<label  for="id">User</label>
					<form:input path="username" id="id" cssClass="form-control" />
					</div>
					<div class="form-group">
					<label for="name">Họ và tên</label>
					<form:input path="fullname" type="text" id="name" cssClass="form-control"/>
					</div>
					<div class="form-check">
					<label class="form-check-label" for="user">Quyền người dùng</label>
					<form:radiobuttons items="${actvited}" path="activated" class="form-check-input" />
					</div>
					<div class="form-check">
					<label  class="form-check-label" for="admin">Quyền admin</label>
					<form:radiobuttons items="${admin}" path="admin" class="form-check-input" />
					
					</div>
					<div class="form-group">
					<label for="price">Mật khẩu</label>
					<form:input path="password" id="price" cssClass="form-control"/>					
					</div>
					<div class="form-group">
					<label for="sl">Email</label>
					<form:input path="email"  id="sl" cssClass="form-control"/>
					</div>
					<button type="submit" class="m-0 btn btn-primary float-right">Lưu</button>					
					</form:form>
